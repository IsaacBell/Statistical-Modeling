...
namespace TPF
{
  ...
  {
  public:
    Producer(std::string topic_name_ = "test-topic", std::string broker = "localhost:9092")
    {
      init(topic_name, broker);
    }

    void init(std::string topic_name_ = "test-topic", std::string broker = "localhost:9092")
    {
