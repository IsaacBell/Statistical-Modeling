...
namespace TPF
{
  struct Volatility
  {
    ...
    static float calculate_volatility(float spot_price, int time_steps)
    {
    ...
    ----------------------------------------------------------------------------*/
    static float *find_2d_mean(float **matrix, int num_loops, int time_steps)
    {
      int j;
...
#pragma omp parallel for private(j) reduction(+ \
    ...
    static float rand_gen(float mean, float std_dev)
    {
    ...
    static float *run_black_scholes_model(float spot_price, int time_steps, float risk_rate, float volatility)
    {
  ...
  private:
    ...
    // Main function
    //----------------------------------------------------------------------------
    int _example_main_fn(int argc, char **argv)
    {
      clock_t t = clock();
